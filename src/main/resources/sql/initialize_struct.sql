...
CREATE TABLE ITEM (VULBIS_ID integer NOT NULL, NOM varchar(100) NOT NULL, TYPE_ID integer NOT NULL);
CREATE TABLE PRICE (VULBIS_ID integer NOT NULL, SERVER_ID integer NOT NULL,	PRICE_ONE integer, PRICE_TEN integer, PRICE_HUNDRED integer, LAST_REFRESH_DATE timestamp, LAST_PRICE_UPDATE_DATE timestamp);
...
CREATE TABLE TX_BRISAGE (VULBIS_ID integer NOT NULL, SERVER_ID integer NOT NULL, TAUX integer, LAST_REFRESH_DATE timestamp, LAST_TX_UPDATE_DATE timestamp);
...
ALTER TABLE STAT_ITEM ADD CONSTRAINT FK_STAT_ITEM_ITEM FOREIGN KEY (ITEM_ID_VULBIS) REFERENCES ITEM(VULBIS_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;
